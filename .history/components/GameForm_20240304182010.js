...
function GameForm({ obj }) {
  ...
  return (
    <Form onSubmit={handleSubmit} className="bg-black p-4 border border-transparent">
      ...
      <FloatingLabel controlId="floatingInput1" label="Game Title" className="mb-3">
        <Form.Control
          ...
          required
          style={{ backgroundColor: 'black', color: 'white', border: 'transparent' }}
        />
      </FloatingLabel>
