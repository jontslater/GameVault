...
function GameCard({ gameObj, onUpdate }) {
  ...
  <Button variant="primary" style={{ backgroundColor: 'black', color: 'black', display: 'flex', alignItems: 'center', justifyContent: 'center', marginBottom: '10px' }} href={gameObj.youTubeVideo} target="_blank" rel="noopener noreferrer">
