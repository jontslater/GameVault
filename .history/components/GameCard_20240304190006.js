      ...
      <Card.Body className="text-center">
        ...
        <div className="d-flex justify-content-center">
          <Button
            variant="primary"
            style={{
              backgroundColor: 'black', color: 'white', border: '1px solid black', display: 'flex',
            }}
            href={gameObj.youTubeVideo}
            target="_blank"
            rel="noopener noreferrer"
          >
            <i className="fab fa-youtube" style={{ color: 'red', display: 'flex', justifyContent: 'center' }} /> YouTube Video
          </Button>
        </div>
