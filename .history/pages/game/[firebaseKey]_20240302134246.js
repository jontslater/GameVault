  ...
  return (
    ...
    >
      <Card.Body className="d-flex flex-column align-items-center">
        ...
        <Button variant="primary" style={{ backgroundColor: 'black', color: 'white', border: '1px solid white' }} href={gameDetails.youTubeVideo} target="_blank" rel="noopener noreferrer">
          YouTube Video
        </Button>
        <br />
        <Link href={`/game/edit/${gameDetails.firebaseKey}`} passHref>
          <Button variant="info" style={{ backgroundColor: 'black', color: 'white', border: '1px solid white' }}>EDIT</Button>
        </Link>
      </Card.Body>
    </Card>
  );
